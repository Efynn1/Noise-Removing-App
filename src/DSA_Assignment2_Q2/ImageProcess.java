    ...
    public void cleanNoise()
    {
        ...
        for(int i = 1; i < hight-1; i++)
        {
            for(int j = 1; j < width-1; j++)
            {
                ...
                //arr.setArray(intensity_r)
                arr.quickSort(intensity_r, 0, intensity_r.length-1);
                  SortableArray arr2 = new SortableArray();
                //arr.setArray(intensity_g);
                arr.quickSort(intensity_g, 0, intensity_g.length-1);
                  SortableArray arr3 = new SortableArray();
                //arr.setArray(intensity_b);
                arr.quickSort(intensity_b, 0, intensity_b.length-1);
